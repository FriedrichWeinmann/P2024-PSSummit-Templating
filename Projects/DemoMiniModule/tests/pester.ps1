...
Remove-Module DemoMiniModule -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\DemoMiniModule\DemoMiniModule.psd1"
Import-Module "$PSScriptRoot\..\DemoMiniModule\DemoMiniModule.psm1" -Force
