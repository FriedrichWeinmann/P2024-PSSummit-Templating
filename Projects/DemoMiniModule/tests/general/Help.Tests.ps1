...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\DemoMiniModule\functions", "$global:testroot\..\DemoMiniModule\internal\functions"),
	
	[string]
	$ModuleName = "DemoMiniModule",
...
$CommandPath = @(
    "$global:testroot\..\DemoMiniModule\functions"
    "$global:testroot\..\DemoMiniModule\internal\functions"
)
